...
namespace anaUtils{
  ...
  Int_t GetTopology(const AnaTrueVertex& trueVertex, const SubDetId::SubDetEnum det=SubDetId::kSubdet1_1, bool IsAntinu = false);

    /// Classify reaction topologies in special attention to MEC process
  Int_t GetMECTopology(const AnaTrueVertex& trueVertex, const SubDetId::SubDetEnum det=SubDetId::kSubdet1_1,bool IsAntinu = false);

  /// Fill the categories for color drawing.
  void FillCategories(AnaEventB* event,       AnaParticleB* part,        const std::string& prefix, const SubDetId::SubDetEnum det=SubDetId::kSubdet1_1, bool IsAntinu = false, bool useCATSAND = true);
  void FillCategories(AnaEventB* event,       AnaParticleB* part,                                   const SubDetId::SubDetEnum det=SubDetId::kSubdet1_1, bool IsAntinu = false, bool useCATSAND = true);
  ...
  Int_t GetReaction(const AnaTrueVertex& trueVertex, const SubDetId::SubDetEnum det=SubDetId::kSubdet1_1, bool IsAntinu = false);
  Int_t GetReactionCC(const AnaTrueVertex& trueVertex, const SubDetId::SubDetEnum det=SubDetId::kSubdet1_1, bool IsAntinu = false);
  ...
  Int_t GetReactionSand(const AnaEventB& event, const AnaParticleB& part, const SubDetId::SubDetEnum det=SubDetId::kSubdet1_1, bool IsAntinu = false);
  Int_t GetReactionSand(const AnaEventB& event, const AnaTrueVertex& trueVertex,const SubDetId::SubDetEnum det=SubDetId::kSubdet1_1, bool IsAntinu = false);
  Int_t GetReactionSandCC(const AnaEventB& event, const AnaParticleB& part, const SubDetId::SubDetEnum det=SubDetId::kSubdet1_1, bool IsAntinu = false);
  Int_t GetReactionSandCC(const AnaEventB& event, const AnaTrueVertex& trueVertex,const SubDetId::SubDetEnum det=SubDetId::kSubdet1_1, bool IsAntinu = false);
