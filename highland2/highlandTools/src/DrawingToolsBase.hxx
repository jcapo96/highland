...
public :
  ...
  /// 1D histos with specified legend
  TH1* Draw(TTree* tree, const std::string& var, int nbins, double* xbins, const std::string& categ,
            const std::string& cut, const std::string& root_opt, const std::string& opt, const std::string& leg, double norm=1,bool scale_errors=true);
  TH1* Draw(TTree* tree, const std::string& var, int nbins, double xmin, double xmax, const std::string& categ,
            const std::string& cut, const std::string& root_opt, const std::string& opt, const std::string& leg, double norm=1,bool scale_errors=true);

  
  /// 2D histos
  TH1* Draw(TTree* tree, const std::string& var, int nx, double* xbins, int ny, double* ybins,
            const std::string& categ="all", const std::string& cut="", const std::string& root_opt="", const std::string& opt="", const std::string& leg="", double norm=1,bool scale_errors=true);
  ...
  void DrawHistoStack(HistoStack* hs, const std::string& categ, const std::string& root_opt, const std::string& opt,const std::string& leg="",const std::string& leg_opt="",int mode=2);

  void DrawHistoStack(HistoStack* hs, const std::string& categ, const std::string& root_opt, const std::string& opt, int lc, int lw, int fc, int fs, const std::string& leg="",const std::string& leg_opt="",int mode=2);
  ...
  /// Reset stat position, size and options
  void ResetStat();
  ...
  /// Use auto colors
  void UseAutoColors(){_use_auto_colors=true;}
  
  /// Set the line color of the current histogram..
  void SetLineColor(int color) { _line_color = color; _use_auto_colors=false;}
  void SetLineColor(EColor kColor) { _line_color = kColor; _use_auto_colors=false;}
  ...
  /// Draw two vertical lines with arrows
  void DrawCutLinesVertical(double xval_min, double xval_max, bool addarrow = true, double arrowpos = 0.5);
