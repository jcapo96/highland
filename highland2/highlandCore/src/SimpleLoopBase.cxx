...
//********************************************************************
  ...
  ND::versioning().WriteTreeVector(*GetTree(OutputManager::config));

  // docstrings
  _docStrings.WriteTreeVector(*GetTree(OutputManager::config));

  // Corrections
  _corrections.WriteTreeVector(*GetTree(OutputManager::config));
