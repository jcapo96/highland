...
//********************************************************************
ConfigurationManager::ConfigurationManager():ManagerBase("config","CONF","ConfigurationBase",&_confs_nonull) {
//********************************************************************
...
//********************************************************************
ConfigurationManager::ConfigurationManager(const std::string& file, double norm, const std::string& cut):ManagerBase("config","CONF","ConfigurationBase",&_confs_nonull) {
//********************************************************************
...
//********************************************************************
  ...
  for (UInt_t i=0;i<_confs_nonull.size();i++){
    ConfigurationBase* conf = _confs_nonull[i];    
    if (!conf) continue;
