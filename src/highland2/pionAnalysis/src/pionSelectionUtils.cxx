...
//*****************************************************************************
Float_t pionSelUtils::ComputeRangeMomentum(double trkrange, int pdg){
//*****************************************************************************
...
//*****************************************************************************
Float_t pionSelUtils::ComputeCSDARange(double beammom, int pdg){
//*****************************************************************************
...
//********************************************************************
Float_t pionSelUtils::ComputePIDA(const AnaParticle &track) {
//********************************************************************
...
//********************************************************************
Float_t pionSelUtils::ComputeKineticEnergy(const AnaParticle &part) {
//********************************************************************
...
//********************************************************************
Float_t pionSelUtils::ComputeDeDxFromDqDx(Float_t dqdx_adc) {
//********************************************************************
...
//********************************************************************
Float_t pionSelUtils::ComputeDqDxFromDeDx(Float_t dedx) {
//********************************************************************
...
//********************************************************************
Float_t* pionSelUtils::ExtrapolateToZ(AnaParticle* part, Float_t z, Float_t* posz) {
//********************************************************************
...
//********************************************************************
void pionSelUtils::ComputeBinnedDeDx(const AnaParticle* part, Float_t max_resrange, Int_t nbins, Float_t** avg_dedx){  
//********************************************************************
...
//********************************************************************
AnaTrueParticle* pionSelUtils::FindBeamTrueParticle(const AnaSpillB& spill){  
//********************************************************************
...
//********************************************************************
void pionSelUtils::AddParticles(AnaParticle* part1, AnaParticle* part2){  
//********************************************************************
  ...
  part1->RangeMomentum[0] = pionSelUtils::ComputeRangeMomentum(part1->Length, 13);
  part1->RangeMomentum[1] = pionSelUtils::ComputeRangeMomentum(part1->Length, 2212);
...
//********************************************************************
std::vector<double> pionSelUtils::ComputeDistanceToVertex(AnaParticle* part){
//********************************************************************
