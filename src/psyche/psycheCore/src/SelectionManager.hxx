...
class SelectionManager: public ManagerBase{
 public :
  ...
  */
  ...
  //  void WriteTreeVector(TTree& tree, const std::string& name);  
protected:

  /// Internal storage fo the selections that were added.
  std::vector<SelectionBase*> _eventSelections;
  std::vector<SelectionBase*>* _eventSelections2;
  std::vector<SelectionBase*> _eventSelections3;
  void* _eventSelections4;
